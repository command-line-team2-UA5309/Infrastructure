...
Vagrant configuration for provisioning multiple virtual machines.
...
1. Request `vagrant_command_key` from your team lead
2. Place it in the `ssh_vagrant/` directory
